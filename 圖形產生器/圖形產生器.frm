...
Case "正方形"
Pictures.Line (X, Y)-(X + 邊長 * Sqr(2), Y + 邊長 * Sqr(2)), , B
Case "正三角形"
...
Private Sub 背景顏色_Click(Index As Integer)

Pictures.BackColor = 背景顏色(Index).BackColor

End Sub


Private Sub 顏色選擇_Click(Index As Integer)
